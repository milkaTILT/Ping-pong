...
class Button:
    def __init__(
        ...
        normal_color=(92, 11, 143), hover_color=(100, 100, 100),
...
btn_start = Button(x=200, y=100, width=150, height=40, text='Начать игру')
btn_exit = Button(x=200, y=160, width=150, height=40, text='Выход')
